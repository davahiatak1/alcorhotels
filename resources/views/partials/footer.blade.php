            ...
            <div class="col-md-6 col-lg-4">
                <div class="block-23">
                    ...
                    <ul>
                        ...
                        <li><a href="#"><span class="icon icon-envelope"></span><span class="text"><span class="__cf_email__" data-cfemail="c6afa8a0a986bfa9b3b4a2a9aba7afa8e8a5a9ab">[email&#160;protected]</span></span></a></li>
        ...
        <div class="row pt-5">
            <div class="col-md-12 text-left">
                <p>
                    ...
                    Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="icon-heart" aria-hidden="true"></i> by <a href="#" target="_blank" class="text-primary">Colorlib</a>
                    <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
            </div>
        </div>
